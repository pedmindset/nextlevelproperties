...
<main class="w-full">
        <div class="max-w-7xl mx-auto">
            <div class="flex max-w-5xl mx-auto py-24 mt-24">
              <div class="space-y-7">
                ...
                <div>
                    ...
                    <div>
                        <div class="flex justify-between pt-14">
                            <div class="space-y-5">
                                <p class="uppercase font-bold text-lg px-6">INVESTORS</p>
                            ...
                            <div class="space-y-5">
                                <p class="uppercase font-bold text-lg px-6">governments</p>
                                <div class="border-l-2 border-b-2 border-dashed border-black px-6 py-6 space-y-7">
                        ...
                        <div class="flex justify-between pt-14">
                            <div class="space-y-5">
                                <p class="uppercase font-bold text-lg px-6">DEVELOPERS</p>
                                <div class="border-l-2 border-b-2 border-dashed border-black px-6 py-6 space-y-7">
