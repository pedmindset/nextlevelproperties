<x-layout>
    ...
    <main class="w-full">
        <div class="bg-white">
            <section class="max-w-7xl mx-auto px-20 gap-36  py-24 space-y-20">
                <div class="flex justify-between items-center">
                    <p class="text-black italic font-bold text-lg">GET IN TOUCH</p>
                    <div class="flex gap-x-6">
                        <div class="bg-gray-50 py-4 px-9 rounded-lg text-gray-400">
                ...
                <div class="flex justify-between items-center">
                    <p class="text-black italic font-bold text-lg">Let’s Talk</p>
