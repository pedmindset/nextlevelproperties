        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex max-w-4xl py-32 px-8 mt-12">
                <div class="space-y-24">
                    <p class="text-white text-2xl font-bold">We are here to help you take your projects to the next
                        level. Whether you're interested in our real estate financing, infrastructure investment, or
                        want to explore partnership opportunities, our team is ready to assist you.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <form action="" class="space-y-12 col-span-1 md:col-span-2">
                        <div class="flex gap-x-6 w-full">
                            <div class="relative mt-2 w-full">
                                <input type="text" name="name" id="name"
                                    class="peer block w-full border-0 rounded-t-md bg-gray-50 py-1.5 text-gray-900 focus:ring-0 px-8 sm:text-sm sm:leading-6"
                        ...
                        <div class="relative mt-2">
                            <input type="text" name="name" id="name"
                                class="peer block w-full border-0 rounded-t-md bg-gray-50 py-1.5 text-gray-900 focus:ring-0 px-8 sm:text-sm sm:leading-6"
                                placeholder="+1 456 456 4789">
                            <div class="absolute inset-x-0 bottom-0 border-t border-gray-300 peer-focus:border-t-2 peer-focus:border-indigo-600 "
                                aria-hidden="true"></div>
                        </div>
                        <div class="mt-2">
                            <textarea rows="6" name="comment" id="comment"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 px-8 bg-gray-50 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
